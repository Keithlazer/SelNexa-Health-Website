...
Canonical production logo asset:

- `selnexa-logo.svg`

Legacy raster logo files were retired after the SVG migration.
...
If you need channel-specific raster exports, generate them from `selnexa-logo.svg`.
